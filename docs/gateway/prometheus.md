...
| `openclaw_model_call_time_to_first_byte_seconds` | histogram | `api`, `error_category`, `model`, `outcome`, `provider`, `transport`                      |
...
| `openclaw_webhook_total`                         | counter   | `channel`, `outcome`, `update_type`                                                       |
| `openclaw_webhook_duration_seconds`              | histogram | `channel`, `outcome`, `update_type`                                                       |
| `openclaw_message_processed_total`               | counter   | `channel`, `outcome`, `reason`                                                            |
| `openclaw_message_processed_duration_seconds`    | histogram | `channel`, `outcome`, `reason`                                                            |
| `openclaw_message_dispatch_total`                | counter   | `channel`, `outcome`, `reason`                                                            |
| `openclaw_message_dispatch_duration_seconds`     | histogram | `channel`, `outcome`, `reason`                                                            |
